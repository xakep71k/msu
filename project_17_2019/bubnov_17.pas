...
{
число сравнений постоянно n(n+1)/2 = (n^2 + n)/2
число перемещений n-1 в худшем случае
}
...
{
число сравнений в худщем варианте n*logn
число перемещений всегда одинаково n*logn
}
